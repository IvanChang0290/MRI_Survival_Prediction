...
prediction_model_path = '/root/code/xai-for-brain-img-surv/models/regression_3d_scaled_v1/results/surv_pred_3d_scaled_v1'
age_dict = {}
days_dict = {}
...
layer_name = 'flatten'
mid_layer_model = Model(inputs=surv_model.input, outputs=surv_model.get_layer(layer_name).output)
...
for image_num in range(len(all_images)):
  ...
  pred = mid_layer_model.predict(x=[input_to_model, age])
